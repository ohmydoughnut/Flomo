...
SWIFT_CLASS("_TtC5Timer17ItemTableViewCell")
...
SWIFT_CLASS("_TtC5Timer22TaskListViewController")
...
SWIFT_CLASS("_TtC5Timer19TimerViewController")
@interface TimerViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified timerLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified toggleStartButton;
...
@property (nonatomic, readonly, strong) TaskListViewController * _Nonnull taskList;
@property (nonatomic) NSInteger numberOfPomos;
@property (nonatomic) NSInteger totalNumberOfPomos;
- (void)viewDidLoad;
- (IBAction)toggleStartButtonTapped:(UIButton * _Nonnull)sender;
- (IBAction)resetButtonTapped:(UIButton * _Nonnull)sender;
- (void)runTimer;
- (void)updateTimer;
- (NSString * _Nonnull)timeStringWithTime:(NSTimeInterval)time SWIFT_WARN_UNUSED_RESULT;
- (void)resetTimer;
- (void)showAnimation;
- (void)playSound;
